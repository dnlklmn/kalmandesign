      ...
      <Link to={linkTo}>
        <>
          ...
          <div
            ...
            id="image-container"
            className={`absolute flex h-full w-full flex-col gap-3 ${
          ...
          >
            <div className="border-foreground-contrast h-fit w-full border-4 p-1.5">
              <p className="bg-foreground-contrast h-fit w-fit p-1 text-sm italic">App</p>
            </div>
            <div className="border-foreground-contrast flex h-full w-full gap-3">
              <div className="border-foreground-contrast h-full w-1/5 border-4 p-1.5">
                <p className="bg-foreground-contrast h-fit w-fit p-1 text-sm italic">Project</p>
              </div>
              <div className="border-foreground-contrast h-full w-4/5 border-4 p-1.5">
                <p className="bg-foreground-contrast h-fit w-fit p-1 text-sm italic">Content</p>
              </div>
            </div>
          </div>
          <script></script>
